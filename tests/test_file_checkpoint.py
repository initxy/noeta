...
from noeta.builtins.fs.impl import ReplaceTextTool
...
def test_edit_tool_surfaces_pre_edit_bytes(tmp_path: Path) -> None:
    ...
    result = tool.invoke({"file_path": "f.py", "old_string": "hello", "new_string": "bye"}, ctx)
    ...
    assert dry.invoke(
        {"file_path": "f.py", "old_string": "bye", "new_string": "hi"}, ctx
