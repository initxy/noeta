...
every later request. To use your own HTTP transport, set `HostConfig.mcp_http_post`.
...
- A tool name longer than 64 characters or colliding with another fails fast;
